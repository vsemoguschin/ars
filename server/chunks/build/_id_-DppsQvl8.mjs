...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const saveContractor = async () => {
      try {
        const response = await fetch(`https://faunaplus24.ru/api/contractors/${contractorId}/`, {
          method: "PATCH",
          headers: {
    ...
    const addAddress = async () => {
      try {
        const response = await fetch("https://faunaplus24.ru/api/contractor-addresses/", {
          method: "POST",
          headers: {
            "Content-Type": "application/json"
          },
    ...
    const deleteAddress = async (id) => {
      try {
        const response = await fetch(`https://faunaplus24.ru/api/contractor-addresses/${id}/`, {
          method: "DELETE"
        });
        if (!response.ok) throw new Error(`HTTP Error: ${response.status}`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_UiTableCaption, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`\u0421\u043F\u0438\u0441\u043E\u043A \u0430\u0434\u0440\u0435\u0441\u0441\u043E\u0432.`);
                } else {
                  return [
                    createTextVNode("\u0421\u043F\u0438\u0441\u043E\u043A \u0430\u0434\u0440\u0435\u0441\u0441\u043E\u0432.")
                  ];
                }
              }),
              _: 1
...
//# sourceMappingURL=_id_-DppsQvl8.mjs.map
