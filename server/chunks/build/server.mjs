import { hasInjectionContext, inject, version, ref, watchEffect, watch, getCurrentInstance, h, defineComponent, createElementBlock, defineAsyncComponent, computed, unref, Suspense, nextTick, mergeProps, Transition, provide, useSSRContext, createApp, effectScope, shallowReactive, reactive, getCurrentScope, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw } from 'vue';
import { $ as $fetch, h as hasProtocol, i as isScriptProtocol, k as joinURL, w as withQuery, s as sanitizeStatusCode, l as getContext, m as createHooks, c as createError$1, t as toRouteMatcher, n as createRouter$1, o as defu } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "contractors-id",
    path: "/contractors/:id()",
    component: () => import('./_id_-B2hdNG2z.mjs')
  },
  {
    name: "contractors",
    path: "/contractors",
    component: () => import('./index-BA9vrS3_.mjs')
  },
  {
    name: "index copy",
    path: "/index%20copy",
    component: () => import('./index copy-B78jZM6K.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-DMjxVFSU.mjs')
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./login-CbqW-mhp.mjs')
  },
  {
    name: "orders-id",
    path: "/orders/:id()",
    meta: __nuxt_page_meta,
    component: () => import('./_id_-DlNvv64k.mjs')
  },
  {
    name: "orders",
    path: "/orders",
    component: () => import('./index-CN08AcNs.mjs')
  },
  {
    name: "prepayments-id",
    path: "/prepayments/:id()",
    component: () => import('./_id_-D7Trlvgv.mjs')
  },
  {
    name: "prepayments",
    path: "/prepayments",
    component: () => import('./index-BYCb7Eff.mjs')
  },
  {
    name: "users-id",
    path: "/users/:id()",
    component: () => import('./_id_-BMODdSIA.mjs')
  },
  {
    name: "users",
    path: "/users",
    component: () => import('./index-B7YatjuA.mjs')
  },
  {
    name: "vehicles-id",
    path: "/vehicles/:id()",
    component: () => import('./_id_-B5U-1G_U.mjs')
  },
  {
    name: "vehicles",
    path: "/vehicles",
    component: () => import('./index-Blk_kl_Y.mjs')
  }
];
...
const namedMiddleware = {
  "log-referrer": () => import('./logReferrer-B7VPt8Yb.mjs')
};
...
const plugin_server_ano7jnMEqi = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  var _a;
  const colorMode = ((_a = nuxtApp.ssrContext) == null ? undefined : _a.islandContext) ? ref({}) : useState("color-mode", () => reactive({
    preference,
    value: preference,
    unknown: true,
    forced: false
...
const axios_QMFgzss1s4 = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  const router = useRouter();
  const baseURL2 = "https://faunaplus24.ru/api/";
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-f4w0wCeT.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const _Error404 = defineAsyncComponent(() => import('./error-404-CitPhPd6.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CZNsKNr_.mjs'));
...
export { LayoutMetaSymbol as L, PageRouteSymbol as P, _export_sfc as _, navigateTo as a, useNuxtApp as b, useRuntimeConfig as c, useHead as d, entry$1 as default, useRoute as e, defineNuxtRouteMiddleware as f, generateRouteKey$1 as g, appPageTransition as h, appKeepalive as i, _wrapIf as j, nuxtLinkDefaults as n, resolveRouteObject as r, toArray as t, useRouter as u, wrapInKeepAlive as w };
