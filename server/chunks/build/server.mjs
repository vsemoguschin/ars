...
const _routes = [
  {
    name: "contractors-id",
    path: "/contractors/:id()",
    component: () => import('./_id_-DppsQvl8.mjs')
  },
  {
    name: "contractors",
    path: "/contractors",
    component: () => import('./index-B2z1I-yh.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-BYK0SErk.mjs')
  },
  {
    name: "orders-id",
    path: "/orders/:id()",
    component: () => import('./_id_-BamWYTRZ.mjs')
  },
  {
    name: "orders",
    path: "/orders",
    component: () => import('./index-D_f3vao3.mjs')
  },
  {
    name: "prepayments-id",
    path: "/prepayments/:id()",
    component: () => import('./_id_-BPQ_gQSS.mjs')
  },
  {
    name: "prepayments",
    path: "/prepayments",
    component: () => import('./index-CCw70ui-.mjs')
  },
  {
    name: "users-id",
    path: "/users/:id()",
    component: () => import('./_id_-D0nt07U4.mjs')
  },
  {
    name: "users",
    path: "/users",
    component: () => import('./index-DvrRHw_H.mjs')
  },
  {
    name: "vehicles-id",
    path: "/vehicles/:id()",
    component: () => import('./_id_-yfEpTZjq.mjs')
  },
  {
    name: "vehicles",
    path: "/vehicles",
    component: () => import('./index-ZQtF-JM2.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-C4pp52a8.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const _Error404 = defineAsyncComponent(() => import('./error-404-Ap6jv6XS.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-C6FQEqoT.mjs'));
...
export { LayoutMetaSymbol as L, PageRouteSymbol as P, _export_sfc as _, navigateTo as a, useNuxtApp as b, useRuntimeConfig as c, useHead as d, entry$1 as default, useRoute as e, appPageTransition as f, generateRouteKey$1 as g, appKeepalive as h, _wrapIf as i, nuxtLinkDefaults as n, resolveRouteObject as r, toArray as t, useRouter as u, wrapInKeepAlive as w };
