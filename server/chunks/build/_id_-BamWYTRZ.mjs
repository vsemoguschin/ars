...
import { u as useRouter, e as useRoute, d as useHead } from './server.mjs';
import 'clsx';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div><div class="p-6"><div class="flex gap-3">`);
      _push(ssrRenderComponent(_component_UiButton, {
        onClick: ($event) => unref(router).push("/orders"),
        class: "h-8 w-8"
      }, {
      ...
      _push(`<h1 class="text-2xl font-bold mb-4">\u0417\u0430\u044F\u0432\u043A\u0430</h1></div>`);
      if (unref(loading)) {
        ...
        _push(ssrRenderComponent(_component_MyCombobox, {
          ...
          label: unref(newOrder).order_type,
        ...
        _push(ssrRenderComponent(_component_MyComboboxModels, {
          ...
          label: unref(newOrder).client_info.name,
        ...
        _push(ssrRenderComponent(_component_MyComboboxModels, {
          ...
          label: unref(newOrder).client_address_info.address,
        ...
        _push(ssrRenderComponent(_component_MyComboboxModels, {
          items: unref(contractors).map((contractor) => ({ value: contractor.id, label: contractor.name })),
          label: unref(newOrder).supplier_info.name,
        ...
        _push(ssrRenderComponent(_component_MyCombobox, {
          ...
          label: unref(newOrder).vehicle_type,
        ...
        _push(ssrRenderComponent(_component_UiButton, { onClick: updateOrder }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`\u0421\u043E\u0445\u0440\u0430\u043D\u0438\u0442\u044C`);
            } else {
...
//# sourceMappingURL=_id_-BamWYTRZ.mjs.map
